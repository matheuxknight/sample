...
class QuizController extends CommonController
{
	...
	public function actionShow()
	{
		...
		$e = createEnrollmentFromCourse($user, $object);
		if(!$e)
		{
			$this->render('notenrolled', array('object'=>$object, 'quiz'=>$quiz));
			return;
		}
	...
	public function actionHtmlIntro()
	{
		...
		$attempts = getdbocount('QuizAttempt', "quizid=$quiz->quizid and userid=$user->id");
		$questioncount = getdbocount('QuizQuestionEnrollment', "quizid=$quiz->quizid and clozeid=0");
