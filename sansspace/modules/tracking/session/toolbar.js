//
// SansspaceSessionToolbar
//

var SansspaceSessionToolbar =
{
	chartlink:	"/session/chartresults",
	loglink:	"/session/logresults",
	...
	update: function()
	{
		...
		link += "&clients=" + $('#searchclients').val();
		link += "&platforms=" + $('#searchplatforms').val();
