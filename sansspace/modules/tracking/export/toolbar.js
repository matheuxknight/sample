//
// SansspaceCustomExportToolbar
//

var SansspaceCustomExportToolbar =
{
	loglink: "/export/logresults",
	...
	update: function()
	{
		...
		link += "&objectid=" + $('#objectid').val();
		link += "&id=" + this.exportid;
