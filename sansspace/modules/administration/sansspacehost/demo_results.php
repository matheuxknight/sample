...
$sansspacehosts = getdbolist('Sansspacehost', "not sans and not license_active order by $order");
...
echo "<th><a style='color: #555;' href='javascript:admin_setorder(\"signature\");'>Signature</a></th>";
...
// 		echo CHtml::linkButton(mainimg('16x16_bottom.png'),
// 				array('title'=>"Flag for Update",
